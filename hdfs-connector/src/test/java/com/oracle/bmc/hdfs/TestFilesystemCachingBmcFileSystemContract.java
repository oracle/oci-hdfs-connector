...
public class TestFilesystemCachingBmcFileSystemContract extends TestBmcFileSystemContract {
    ...
    public static void setUpStatic() throws Exception {
        ...
        final BmcContract.FilesystemCaching contract = new BmcContract.FilesystemCaching(configuration);
        contract.init();
